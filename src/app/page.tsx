...
export default function HomePage() {
    ...
    return (
        <>
            ...
            <main className="flex flex-col items-center justify-start p-4 md:p-8 pt-6 md:pt-8">
                ...
                <div className="mb-5 w-full max-w-lg animate-fade-in">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl font-extrabold font-display bg-gradient-to-r from-brand-300 via-gold-400 to-brand-400 bg-clip-text text-transparent tracking-tight">
                                    CantonLink
                                </h1>
                ...
                <div className="mb-6 flex gap-1 glass-purple rounded-2xl p-1.5 shadow-lg border-glow">
                    <button
                        ...
                        className={`px-5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 ${activeTab === "swap"
                    ...
                    <button
                        ...
                        className={`px-5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 ${activeTab === "otc"
                            ? "bg-gradient-to-r from-brand-600/25 to-brand-500/15 text-brand-300 shadow-sm border border-brand-500/25"
                            : "text-gray-500 hover:text-gray-300 border border-transparent"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 ${activeTab === "explore"
                            ? "bg-gradient-to-r from-brand-600/25 to-brand-500/15 text-brand-300 shadow-sm border border-brand-500/25"
                            : "text-gray-500 hover:text-gray-300 border border-transparent"
                            }`}
                    >
